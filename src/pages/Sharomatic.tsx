      ...
      return (
        <div className="w-full h-[70vh] flex items-center justify-center bg-muted rounded-lg">
          <div className="text-center p-8">
            ...
            <h3 className="text-xl font-semibold mb-2 text-foreground">{fileName || 'Presentation'}</h3>
            <p className="text-muted-foreground mb-4">PowerPoint presentations require Google Slides or Office Online for viewing</p>
            <a 
      ...
      return (
        <div className="w-full h-[70vh] flex items-center justify-center bg-muted rounded-lg">
          <div className="text-center p-8">
            ...
            <h3 className="text-xl font-semibold mb-2 text-foreground">{fileName || 'File'}</h3>
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 pt-12 pb-24">
        ...
        >
          <h1 className="text-4xl font-bold text-foreground mb-3">Sharomatic</h1>
                ...
                <CardContent className="pt-6">
                  <div className="mb-8">
                    ...
                    <div className="flex items-center justify-center w-full">
                      <label
                        htmlFor="file-upload"
                        className="flex flex-col items-center justify-center w-full h-64 border-2 border-border border-dashed rounded-lg cursor-pointer bg-muted hover:bg-accent transition-colors"
                      >
                  ...
                  {connectCode && (
                    <div className="mt-8 p-4 bg-muted rounded-lg">
                      <h3 className="text-center font-medium text-lg text-foreground mb-3">
                      ...
                      <div className="flex justify-center items-center gap-4 mb-3">
                        {connectCode.split('').map((char, i) => (
                          <div
                            key={i}
                            className="w-12 h-12 flex items-center justify-center rounded-lg bg-background border-2 border-border text-xl font-bold text-foreground"
                          >
                            {char}
                          </div>
                        ))}
